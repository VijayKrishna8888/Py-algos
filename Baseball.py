...
def read_csv_as_list_dict(filename, separator, quote):
    ...
    with open(filename, newline='') as csvfile:
        ...
        for row in csvreader:
            table.append(row)
    return table
#stats_list = read_csv_as_list_dict(r"E:\Books\batting1.csv", ",", '"')
#print(stats_list)
...
def read_csv_as_nested_dict(filename, keyfield, separator, quote):
    ...
    with open(filename, newline='') as csvfile:
        ...
        for row in csvreader:
            ...
            table[rowid] = row
    return table
stats_dict = read_csv_as_nested_dict(r"E:\Books\batting1.csv","player",  ",", '"')
print(stats_dict)
...
def filter_by_year(statistics, year, yearid):
    ...
    for row in statistics:
        if int(row[yearid]) == year:
            new_list.append(row)
    return new_list
#print(filter_by_year(stats_list, 2020, 'year'))
...
# [{'hits': '108', 'year': '2020', 'homers': '5', 'player': 'player0', 'atbats': '300',
#'doubles': '20', 'walks': '25', 'triples': '1'},
# {'hits': '170', 'year': '2020', 'homers': '4', 'player': 'player1', 'atbats': '499',
#'doubles': '5', 'walks': '10', 'triples': '3'},
# {'hits': '129', 'year': '2020', 'homers': '20', 'player': 'player2', 'atbats': '513',
# 'doubles': '18', 'walks': '85', 'triples': '5'},
# {'hits': '67', 'year': '2020', 'homers': '22', 'player': 'player5', 'atbats': '197',
#'doubles': '3', 'walks': '37', 'triples': '2'},
# {'hits': '166', 'year': '2020', 'homers': '18', 'player': 'player6', 'atbats': '542',
#'doubles': '33', 'walks': '25', 'triples': '7'},
# {'hits': '161', 'year': '2020', 'homers': '10', 'player': 'player7', 'atbats': '500',
#'doubles': '19', 'walks': '27', 'triples': '2'},
# {'hits': '176', 'year': '2020', 'homers': '25', 'player': 'player8', 'atbats': '589',
#'doubles': '42', 'walks': '30', 'triples': '13'}],
# batting_average, 2))
...
def lookup_player_names(info, top_ids_and_stats):
    ...
    for idx in top_ids_and_stats:
        f_st = format(idx[1], '.3f') +" --- {0} {1}".format(info_dict[idx[0]][info['firstname']],
                                                            info_dict[idx[0]][info['lastname']])
        new_list.append(f_st)
    return new_list
#
# print(lookup_player_names({'masterfile': r"E:\Books\master1.csv", 'battingfile':
#r"E:\Books\batting1.csv", 'separator': ',', 'quote': '"',
# 'playerid': 'player', 'firstname': 'firstname', 'lastname': 'lastname', 'yearid': 'year',
# 'atbats': 'atbats', 'hits': 'hits', 'doubles': 'doubles', 'triples': 'triples',
#'homeruns': 'homers', 'walks': 'walks',
# 'battingfields': ['atbats', 'hits', 'doubles', 'triples', 'homers', 'walks']},
...
#
#print(lookup_player_names({'masterfile': 'master2.csv', 'battingfile': '', 'separator': ',',
#'quote': '"','playerid': 'playerID', 'firstname': 'nameFirst', 'lastname': 'nameLast',
#'yearid': 'yearID',
...
#
# # test1
# print(compute_top_stats_year({'masterfile': r"E:\Books\master1.csv",
#'battingfile': r"E:\Books\batting1.csv", 'separator': ',', 'quote': '"',
# 'playerid': 'player', 'firstname': 'firstname', 'lastname': 'lastname', 'yearid': 'year',
# 'atbats': 'atbats', 'hits': 'hits', 'doubles': 'doubles', 'triples': 'triples',
#'homeruns': 'homers', 'walks': 'walks',
# 'battingfields': ['atbats', 'hits', 'doubles', 'triples', 'homers', 'walks']},
# batting_average, 3, 2021))
#
# # test2
# #print(compute_top_stats_year({'masterfile': 'master2.csv',
#'battingfile': 'batting2.csv', 'separator': ',', 'quote': '"',
...
# print(compute_top_stats_career({'masterfile': r"E:\Books\master1.csv",
#'battingfile': r"E:\Books\batting1.csv", 'separator': ',', 'quote': '"',
# 'playerid': 'player', 'firstname': 'firstname', 'lastname': 'lastname', 'yearid': 'year',
# 'atbats': 'atbats', 'hits': 'hits', 'doubles': 'doubles', 'triples': 'triples',
#'homeruns': 'homers', 'walks': 'walks',
