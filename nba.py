...
def test_part1_code():
    ...
    test_table = read_csv_file(r"C:\Users\Mahe\Downloads\Programs\test_case.csv")  # create a small CSV for this test
    print_table(test_table)
    print()

    # Test the writer
    cancer_risk_table = read_csv_file(r"C:\Users\Mahe\Downloads\Programs\cancer_risk05_v4_county.csv")
    ...
    for row in range(len(cancer_risk_table)):
        if any(cancer_risk_table[row][col] != cancer_risk_copy[row][col] for col in range(len(cancer_risk_table[0]))):
