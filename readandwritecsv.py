...
print(read_csv_as_list_dict(r"E:\Books\New folder\demand_calculation\demand_example.csv", ",", ";"))
...
print(read_csv_as_nested_dict(r"E:\Books\New folder\demand_calculation\demand_example.csv", 'energy_accumulated_kwh', ',', '"'))
